...
@section('content')
    <h4 class="fw-bold mb-3"><i class="bi bi-plus-lg"></i> Tambah Supplier</h4>
            ...
            <form method="POST" action="{{ route('admin.supplier.store') }}">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="kode_supplier" value="{{ old('kode_supplier') }}" class="form-control" placeholder="Contoh: SUP-09" required>
                    </div>
